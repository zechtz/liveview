defmodule LiveViewAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveViewAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveViewAppWeb.Gettext, "errors", msg, opts)
    end
  end
