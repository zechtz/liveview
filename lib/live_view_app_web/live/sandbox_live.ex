defmodule LiveViewAppWeb.SandboxLive do
  use LiveViewAppWeb, :live_view

  import Number.Currency
  alias LiveViewApp.Sandbox
      ...
      <form phx-change="calculate" phx-submit="get-quote">
        <div class="fields">
          ...
          <div>
            ...
            <div class="input" id="width">
              <input type="number" name="width" value={@width} />
              <span class="unit">feet</span>
            </div>
          </div>
          <div>
            <label for="depth" id="depth">Depth</label>
            <div class="input">
  ...
  def handle_event("calculate", params, socket) do
    ...
    socket = assign(socket, weight: weight, length: l, depth: d, width: w, price: nil)
