defmodule LiveViewApp.Volunteers do
  @moduledoc """
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(LiveViewApp.PubSub, "volunteers")
  end

  def broadcast({:ok, volunteer}, tag) do
    Phoenix.PubSub.broadcast(LiveViewApp.PubSub, "volunteers", {tag, volunteer})
    {:ok, volunteer}
  end
